...
- [x] Classify planar vertical walls above the selected face as raised bosses,
  including rectangular/slot-like boss geometry with deterministic height.
...
| 2026-08-30 | `cac0138` | Detected planar-walled rectangular/slot raised bosses. |
